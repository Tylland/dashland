...
func NewBlockWithCharacteristics(world *World, blockType BlockType, x int, y int, characteristics characteristics.Characteristics) *Block {
	return &Block{world: world, blockType: blockType, position: core.BlockPosition{X: x, Y: y}, characteristics: characteristics}
}

func NewBlock(world *World, blockType BlockType, x int, y int) *Block {
	switch blockType {
	case Void:
		return NewBlockWithCharacteristics(world, blockType, x, y, characteristics.Void)
	case Soil:
		return NewBlockWithCharacteristics(world, blockType, x, y, characteristics.RollOff|characteristics.EnemyObstacle)
	case Wall:
		return NewBlockWithCharacteristics(world, blockType, x, y, characteristics.PlayerObstacle|characteristics.EnemyObstacle)
	case Bedrock:
		return NewBlockWithCharacteristics(world, blockType, x, y, characteristics.PlayerObstacle|characteristics.EnemyObstacle)
	default:
		return NewBlockWithCharacteristics(world, blockType, x, y, characteristics.None)
	}
