...
// 	"github.com/tylland/dashland/game/entity"
// 	"github.com/tylland/dashland/game/utils"
// 	"github.com/tylland/dashland/game/world"
// )
...
// func NewCollisionSystem(world EntityLister) *CollisionSystem {
...
// func (s *CollisionSystem) CheckEntityCollision(entity1 *entity.Entity, position1 *components.PositionComponent, collision1 *components.CollisionComponent) {
...
// func (cs *CollisionSystem) resolveEntityCollision(entity1, entity2 *entity.Entity) {
...
// func (cs *CollisionSystem) resolveBlockCollision(entity *entity.Entity, block *world.Block) {
// 	// Get the rectangles for overlap calculation
// 	entityRect := entity.Collision.BoxBody.Rectangle(entity.Position.Vector2)
// 	blockRect := block.Rectangle()
